...
void display_board() {
  ...
  std::cout << "     _________________" << std::endl;
	std::cout << "    |     |     |     |" << std::endl;
	std::cout << "0   |" << "  " << board[0][0] << "  |  " << board[0][1] << "  |  " << board[0][2] << "  " << "|   0" << std::endl;
	std::cout << "    |_____|_____|_____|" << std::endl;
	std::cout << "    |     |     |     |" << std::endl;
	std::cout << "1   |" << "  " << board[1][0] << "  |  " << board[1][1] << "  |  " << board[1][2] << "  " << "|   1" << std::endl;
	std::cout << "    |_____|_____|_____|" << std::endl;
	std::cout << "    |     |     |     |" << std::endl;
	std::cout << "2   |" << "  " << board[2][0] << "  |  " << board[2][1] << "  |  " << board[2][2] << "  " << "|   2" << std::endl;
	std::cout << "    |     |     |     |" << std::endl;
  std::cout << "    |_____|_____|_____|" << std::endl;
  std::cout << "                       " << std::endl;
  std::cout << "       0     1     2  " << std::endl;
...
int main() {
  ...
  while (realWinner == "null") {
	...
	display_board();
  if (realWinner == "tie"){
	std::cout << "Game Over! The game was a " << realWinner << "." << std::endl;
  } else {
